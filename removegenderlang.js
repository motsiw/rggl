...
function removeGender(sollrot) {
	...
	for (i = 0; i < result.length; i++) {
	  ...
	  str = str.replace(/([V|v]iele|[V|v]ielen|[E|e]inigen|[E|e]inige|[M|m]ehreren|[A|a]llen|[A|a]lle|[W|w]enige|[E|e]tliche|[D|d]iversen|[W|w]enigen|[E|e]tlichen|[M|m]eisten|[W|w]enigsten|[E|e]in paar|Zahl der|Teil der) Autofahrenden([ ,).:“\?"!\-\/\<\&]|$)/g,"$1 "+rot1+"Autofahrern"+rot2+"$2");
	  ...
	  str = str.replace(/(dem|einen|den|einem|diesen|diesem|nchen|elen|igen|nchem|jenem) ([a-zA-ZüöäßÜÖÄ]*?)(tient|sell|igur|leg|log|pert|gog|oss|äst|atz|eug|eamt|hirt|peut|ilot|mat)(\·in|\:in|\*in|\_in|\/\-in|\/in|\(in\))([ ,).:“\?"!\-\/\<\&]|$)/gi,rot1+"$1 $2$3en"+rot2+"$5");
	  str = str.replace(/(dem|einen|den|einem|diesen|diesem|nchen|elen|igen|nchem|jenem) ([a-zA-ZüöäßÜÖÄ]*?)(tient|sell|igur|leg|log|pert|gog|oss|äst|atz|eug|eamt|hirt|Hirt|peut|ilot|mat)In([ ,).:“\?"!\-\/\<\&]|$)/g,rot1+"$1 $2$3en"+rot2+"$4");

...
function removeGender(sollrot) {
	...
	for (i = 0; i < result.length; i++) {
	  ...
	  str = str.replace(/(v|V)eräusser(\·in|\:in|\*in|\/\-in|\_in|\/in|\(in|In\))/g,"$1eräusserer$2");
	  str = str.replace(/(f|F)ütter(\·in|\:in|\*in|\/\-in|\_in|\/in|\(in|In\))/g,"$1ütterer$2");
	  
	  

	  // Partizipien
	  str = str.replace(/([V|v]iele|[E|e]inige|[M|m]ehrere|[A|a]lle|[W|w]enige|[E|e]tliche|[E|e]in paar| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig |vierzig| fünfzig| hundert| tausend| hunderte| tausende| dass| weil| für| durch) Studierende([ ,).:“\?"!\-\/\<\&]|$)/g,"$1 "+rot1+"Studenten"+rot2+"$2");
	  ...
	  str = str.replace(/([V|v]iele|[V|v]ielen|[E|e]inigen|[E|e]inige|[M|m]ehreren|[A|a]llen|[A|a]lle|[W|w]enige|[E|e]tliche|[D|d]iversen|[W|w]enigen|[E|e]tlichen|[M|m]eisten|[W|w]enigsten|[V|v]ieler|[E|e]iniger|[V|v]iele|[E|e]inige|[M|m]ehrerer|[A|a]ller|[D|d]iverser|[W|w]eniger|[E|e]tlicher|ein paar|Teil der|Zahl der| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend| hunderten| tausenden| mit| die| bei| diese| von) (Studierender|Studierenden)([ ,).:“\?"!\-\/\<\&]|$)/g,"$1 "+rot1+"Studenten"+rot2+"$3");

	  str = str.replace(/([V|v]iele|[E|e]inige|[M|m]ehrere|[A|a]lle|[W|w]enige|[E|e]tliche|[E|e]in paar| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend| hunderte| tausende| dass| weil| für| durch) Dozierende([ ,).:“\?"!\-\/\<\&]|$)/g,"$1 "+rot1+"Dozenten"+rot2+"$2");
	  str = str.replace(/([V|v]iele|[V|v]ielen|[E|e]inigen|[E|e]inige|[M|m]ehreren|[A|a]llen|[A|a]lle|[W|w]enige|[E|e]tliche|[D|d]iversen|[W|w]enigen|[E|e]tlichen|[M|m]eisten|[W|w]enigsten|[V|v]ieler|[E|e]iniger|[V|v]iele|[E|e]inige|[M|m]ehrerer|[A|a]ller|[D|d]iverser|[W|w]eniger|[E|e]tlicher|ein paar|Teil der|Zahl der| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend| hunderten| tausenden| mit| die| bei| diese| von) (Dozierender|Dozierenden)([ ,).:“\?"!\-\/\<\&]|$)/g,"$1 "+rot1+"Dozenten"+rot2+"$3");
	  
	  str = str.replace(/([V|v]iele|[E|e]inige|[M|m]ehrere|[A|a]lle|[W|w]enige|[E|e]tliche|[E|e]in paar| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend| hunderte| tausende| dass| weil| für| durch) Demonstrierende([ ,).:“\?"!\-\/\<\&]|$)/g,"$1 "+rot1+"Demonstranten"+rot2+"$2");
	  str = str.replace(/(Demonstrierenden)(zahl|anteil|vertretung|gruppe)/g,rot1+"Demonstranten"+rot2+"$2");
	  str = str.replace(/([V|v]iele|[V|v]ielen|[E|e]inigen|[E|e]inige|[M|m]ehreren|[A|a]llen|[A|a]lle|[W|w]enige|[E|e]tliche|[D|d]iversen|[W|w]enigen|[E|e]tlichen|[M|m]eisten|[W|w]enigsten|[V|v]ieler|[E|e]iniger|[V|v]iele|[E|e]inige|[M|m]ehrerer|[A|a]ller|[D|d]iverser|[W|w]eniger|[E|e]tlicher|ein paar|Teil der|Zahl der| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend| hunderten| tausenden| mit| die| bei| diese| von) (Demonstrierender|Demonstrierenden)([ ,).:“\?"!\-\/\<\&]|$)/g,"$1 "+rot1+"Demonstranten"+rot2+"$3");
	  ...
	  str = str.replace(/(die|ihre|meine|unsere|seine|keine|manche)(| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend) (Beamt|Verwandt|Bekannt|Angestellt)(\·innen|\:innen|\*innen|\_innen|\/\-innen|\/innen|\(innen\))([ ,).:“\?"!\-\/\<\&]|$)/gi,rot1+"$1$2 $3en"+rot2+"$5");
	  str = str.replace(/(die|ihre|meine|unsere|seine|keine|manche)(| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend) (Beamt|Verwandt|Bekannt|Angestellt)(Innen)([ ,).:“\?"!\-\/\<\&]|$)/g,rot1+"$1$2 $3en"+rot2+"$5");
	  ...
	  str = str.replace(/( den|von|mit|auf|unter|elen| vor|zu|igen| aus| an|bei|außer|ausser|nach|samt|seit|llen|nchen|meinen|seinen|keinen| laut|unseren|ihren| neben|jenen)(| fast| beinahe| mehr als| weniger als| rund| aufgerundet| abgerundet| durchschnittlich| knapp)(| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend| [a-zA-ZüöäßÜÖÄ]*?en) ([a-zA-ZüöäßÜÖÄ\-]*?[bcdfghjklmnpqstvwxz])(\·innen|\:innen|\*innen|\_innen|\/\-innen|\/innen|\(innen\))([ ,).:“\?"!\-\/\<\&]|$)/gi,rot1+"$1$2$3 $4en"+rot2+"$6");
	  str = str.replace(/( den|von|mit|auf|unter|elen| vor|zu|igen| aus| an|bei|außer|ausser|nach|samt|seit|llen|nchen|meinen|seinen|keinen| laut|unseren|ihren| neben|jenen)(| fast| beinahe| mehr als| weniger als| rund| aufgerundet| abgerundet| durchschnittlich| knapp)(| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend| [a-zA-ZüöäßÜÖÄ]*?en) ([a-zA-ZüöäßÜÖÄ\-]*?[bcdfghjklmnpqstvwxz])Innen([ ,).:“\?"!\-\/\<\&]|$)/g,rot1+"$1$2$3 $4en"+rot2+"$5");
	  ...
	  str = str.replace(/( erlaub| gesteh| gestand|sag| ähnel| antwort| begegn| befehl| befahl| dank| dien| droh| folg| gehorch| gehör| genüg| glaub| gratulier| helf| hilf| half|fall|fäll|fiel| missling| misslang| pass| passier| schmeck| vertrau| verzeih| widersprech| widersprach| rat| rät| riet)(|e|st|est|t|et|en|t|et|te|ete|test|te|ten||eten|tet|etet)(| fast| beinahe| mehr als| weniger als| rund| aufgerundet| abgerundet| durchschnittlich| knapp)(| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend| [a-zA-ZüöäßÜÖÄ]*?en) ([a-zA-ZüöäßÜÖÄ\-]*?[bcdfghjklmnpqstvwxz])Innen([ ,).:“\?"!\-\/\<\&]|$)/g,rot1+"$1$2$3$4 $5en"+rot2+"$6");
	  ...
	  str = str.replace(/( den|von|mit|auf|unter|elen| vor|zu|igen| aus| an|bei|außer|ausser|nach|samt|seit|llen|nchen|meinen|seinen|keinen| laut|unseren|ihren| neben|jenen)(| fast| beinahe| mehr als| weniger als| rund| aufgerundet| abgerundet| durchschnittlich| knapp)(| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend| [a-zA-ZüöäßÜÖÄ]*?en) ([a-zA-ZüöäßÜÖÄ\-]*?)(or|fahr|gar|eur|dar|tär|när|tar|ssar|gur|ivar|agier)(\·innen|\:innen|\*innen|\_innen|\/\-innen|\/innen|\(innen\))([ ,).:“\?"!\-\/\<\&]|$)/gi,rot1+"$1$2$3 $4$5en"+rot2+"$7");
	  str = str.replace(/( den|von|mit|auf|unter|elen| vor|zu|igen| aus| an|bei|außer|ausser|nach|samt|seit|llen|nchen|meinen|seinen|keinen| laut|unseren|ihren| neben|jenen)(| fast| beinahe| mehr als| weniger als| rund| aufgerundet| abgerundet| durchschnittlich| knapp)(| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend| [a-zA-ZüöäßÜÖÄ]*?en) ([a-zA-ZüöäßÜÖÄ\-]*?)(or|fahr|gar|eur|dar|tär|när|tar|ssar|gur|ivar|agier)Innen([ ,).:“\?"!\-\/\<\&]|$)/g,rot1+"$1$2$3 $4$5en"+rot2+"$6");

	  str = str.replace(/( erlaub| gesteh| gestand|sag| ähnel| antwort| begegn| befehl| befahl| dank| dien| droh| folg| gehorch| gehör| genüg| glaub| gratulier| helf| hilf| half|fall|fäll|fiel| missling| misslang| pass| passier| schmeck| vertrau| verzeih| widersprech| widersprach| rat| rät| riet)(|e|st|est|t|et|en|t|et|te|ete|test|te|ten||eten|tet|etet)(| fast| beinahe| mehr als| weniger als| rund| aufgerundet| abgerundet| durchschnittlich| knapp)(| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend| [a-zA-ZüöäßÜÖÄ]*?en) ([a-zA-ZüöäßÜÖÄ\-]*?)(or|fahr|gar|eur|dar|tär|när|tar|ssar|gur|ivar|agier)(\·innen|\:innen|\*innen|\_innen|\/\-innen|\/innen|\(innen\))([ ,).:“\?"!\-\/\<\&]|$)/gi,rot1+"$1$2$3$4 $5$6en"+rot2+"$8");
	  str = str.replace(/( erlaub| gesteh| gestand|sag| ähnel| antwort| begegn| befehl| befahl| dank| dien| droh| folg| gehorch| gehör| genüg| glaub| gratulier| helf| hilf| half|fall|fäll|fiel| missling| misslang| pass| passier| schmeck| vertrau| verzeih| widersprech| widersprach| rat| rät| riet)(|e|st|est|t|et|en|t|et|te|ete|test|te|ten||eten|tet|etet)(| fast| beinahe| mehr als| weniger als| rund| aufgerundet| abgerundet| durchschnittlich| knapp)(| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend| [a-zA-ZüöäßÜÖÄ]*?en) ([a-zA-ZüöäßÜÖÄ\-]*?)(or|fahr|gar|eur|dar|tär|när|tar|ssar|gur|ivar|agier)Innen([ ,).:“\?"!\-\/\<\&]|$)/g,rot1+"$1$2$3$4 $5$6en"+rot2+"$7");
	  ...
	  str = str.replace(/( erlaub| gesteh| gestand|sag| ähnel| antwort| begegn| befehl| befahl| dank| dien| droh| folg| gehorch| gehör| genüg| glaub| gratulier| helf| hilf| half|fall|fäll|fiel| missling| misslang| pass| passier| schmeck| vertrau| verzeih| widersprech| widersprach| rat| rät| riet)(|e|st|est|t|et|en|t|et|te|ete|test|te|ten||eten|tet|etet)(| fast| beinahe| mehr als| weniger als| rund| aufgerundet| abgerundet| durchschnittlich| knapp)(| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend| [a-zA-ZüöäßÜÖÄ]*?en) ([a-zA-ZüöäßÜÖÄ\-]*?r)(Innen)([ ,).:“\?"!\-\/\<\&]|$)/g,rot1+"$1$2$3$4 $5n"+rot2+"$7");
	  ...
	  str = str.replace(/( der|ner|nger|rer)(| fast| beinahe| mehr als| weniger als| rund| aufgerundet| abgerundet| durchschnittlich| knapp)(| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend| [a-zA-ZüöäßÜÖÄ]*?en) ([a-zA-ZüöäßÜÖÄ\-]*?)(eur|pst|bst|hund|dar|ölf|pitän|tär|när|wält|dät|slim|eamt|annt|llt|reund|rzt|ssar|wirt|eind|ivar)(\·innen|\:innen|\*innen|\_innen|\/\-innen|\/innen|\(innen\))([ ,).:“\?"!\-\/\<\&]|$)/gi,"$1$2"+rot1+"$3 $4$5e"+rot2+"$7");
	  str = str.replace(/( der|ner|nger|rer)(| fast| beinahe| mehr als| weniger als| rund| aufgerundet| abgerundet| durchschnittlich| knapp)(| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend| [a-zA-ZüöäßÜÖÄ]*?en) ([a-zA-ZüöäßÜÖÄ\-]*?)(eur|pst|bst|hund|Hund|dar|ölf|pitän|tär|när|wält|dät|slim|eamt|annt|llt|reund|rzt|ssar|Wirt|wirt|eind|ivar)Innen([ ,).:“\?"!\-\/\<\&]|$)/g,"$1$2"+rot1+"$3 $4$5e"+rot2+"$6");
 
	  // Genitiv plural bei den übrigen Nomen - innen wird durch en ersetzt
	  str = str.replace(/( der|ner|nger|rer)(| fast| beinahe| mehr als| weniger als| rund| aufgerundet| abgerundet| durchschnittlich| knapp)(| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend| [a-zA-ZüöäßÜÖÄ]*?en) ([a-zA-ZüöäßÜÖÄ\-]*?[bcdfghjklmnpqstvwxz])(\·innen|\:innen|\*innen|\_innen|\/\-innen|\/innen|\(innen\))([ ,).:“\?"!\-\/\<\&]|$)/gi,"$1$2"+rot1+"$3 $4en"+rot2+"$6");
	  str = str.replace(/( der|ner|nger|rer)(| fast| beinahe| mehr als| weniger als| rund| aufgerundet| abgerundet| durchschnittlich| knapp)(| [0-9,.]+?| zwei| drei| vier| fünf| sechs| sieben| acht| neun| zehn| elf| zwölf| zwanzig| dreißig| dreissig| vierzig| fünfzig| hundert| tausend| [a-zA-ZüöäßÜÖÄ]*?en) ([a-zA-ZüöäßÜÖÄ\-]*?[bcdfghjklmnpqstvwxz])Innen([ ,).:“\?"!\-\/\<\&]|$)/g,"$1$2"+rot1+"$3 $4en"+rot2+"$5");
	  ...
	  str = str.replace(/(narch|pars|sell|orb|ries|ilot|esid|nes|les|klav|isst|krut|igur|erad|or|ist|leg|nom|log|pert|naut|fahr|rat|dat|gog|oss|äst|ent|lyst|graf|zos|atz|ess|fal|ant|peut|urd|lient|fährt|ürk|ghan|gar|inn|dän|Dän|män|asach|les|sbek|bell|mad|iech|iton|ovar|eug|wed|tekt|ir|Ir|eld|siat|Russ|Weißruss||Weisruss|kund|Kund|soph|mand|erb|Erb|lik|thlet|atar|eran|names|bet|arr|rinz|hirt|Hirt|iot|brit|Brit|mat|päd)(Innen)([ ,).:“\?"!\-\/\<\&]|$)/g,rot1+"$1en"+rot2+"$3");
